                        ...
                        <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                            <div class="align-items-center d-flex justify-content-between mb-2">
                                ...
                                <div class="d-flex flex-row align-items-center">
                                    <button type="button" class="btn btn-primary mx-2 btn-modal btn-add" data-bs-toggle="modal" data-bs-target="#exampleModal">Thêm</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:Button ID="ButtonAdd" CssClass="btn btn-primary" runat="server" Text="Lưu" OnClick="ButtonSave_Click" />
                    </div>
                </div>
            </div>
        </div>
